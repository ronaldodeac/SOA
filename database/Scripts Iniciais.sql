...
create table dispositivo (id int auto_increment primary key not null, descricao varchar(45), status_dispositivo varchar(20), criado_em datetime);
...
create table usuario (id int auto_increment primary key not null, nome varchar(45), token varchar(100));

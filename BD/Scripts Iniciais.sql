...
create table dispositivo (id int auto_increment primary key not null, descricao varchar(45), status_dispositivo varchar(20), criado_em datetime, token varchar(100));
